"""
Model Components for Voxel Cluster Density Attention Network (VCDA-Net)

This package contains modular components for the hybrid density attention map model:
- utils: Helper functions for density attention map processing
