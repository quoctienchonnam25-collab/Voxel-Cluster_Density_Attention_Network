...
This experiment applies the **Hybrid Saliency V4** model to predict brain age gap in Alzheimer's Disease (AD) and Mild Cognitive Impairment (MCI) patients from the ADNI dataset.
