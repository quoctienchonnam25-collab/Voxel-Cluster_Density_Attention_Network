# VCDA-Net - Complete Training Pipeline

This module provides the complete pipeline for regional brain age prediction using the VCDA-Net model.
...
The pipeline uses the trained VCDA-Net model:
...
This pipeline is adapted for the **VCDA-Net** model which differs from the original GradCAM V4:

| Feature | GradCAM V4 | VCDA-Net |
|---------|------------|-------------|
...
- Model architecture: `src/vcda_net/model/vcda_net.py`
- Experiments: `src/vcda_net/experiments/ad_prediction/`
...
**Created**: 2026-02-17  
**Model**: VCDA-Net  
**Checkpoint**: `vcda_net_20260216_011913`
