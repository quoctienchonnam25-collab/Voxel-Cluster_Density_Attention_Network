...
**Full Path**: 
```
/media/devin/WORK/devin/tien/src/brain_age_prediction/hybrid_saliency_v4_package/src/hybrid_saliency_v4/experiments/ad_prediction/results/
```

**Relative to Package Root**:
```
src/hybrid_saliency_v4/experiments/ad_prediction/results/
```
