...
This script trains the HybridSaliencyEnhanced model with:
- Dual-path features: Original (256) + Saliency Map (256) = 512-dim
- Per-channel activation magnitude-based saliency maps (NO gradients!)
...
from hybrid_saliency_v4.training.loss_functions import get_loss_function, HuberLoss
...
def main():
    ...
    parser.add_argument('--top_k', type=int, default=128,
                       help='Number of top voxels from saliency map')
    ...
    # Other
    parser.add_argument('--output_dir', type=str, default='saliency_runs',
    ...
    if args.run_name is None:
        ...
        args.run_name = f'saliency_enhanced_{timestamp}'
    ...
    print("⚠️  Note: Using activation magnitude-based saliency maps (NOT GradCAM)")
    print("="*70)
