#!/usr/bin/env python3
"""
Extract Regional Features from VCDA-Net Model

This script extracts 32 regional feature vectors from the trained
VCDA-Net model for use in regional predictor training.
...
class RegionalFeatureExtractor:
    """Extract regional features from trained VCDA-Net model."""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Extract regional features from VCDA-Net model'
    )
    parser.add_argument(
        '--checkpoint',
        type=str,
    ...
    print("="*80)
    print("EXTRACT REGIONAL FEATURES - VCDA-NET")
    print("="*80)
