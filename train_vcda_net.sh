...
# 
# This script trains the VCDANet model with density attention map
...
echo -e "${BLUE}================================================================================${NC}"
echo -e "${BLUE}                                                                                ${NC}"
echo -e "${BLUE}         Training Voxel Cluster Density Attention Network (VCDA-Net) - Brain Age Prediction           ${NC}"
echo -e "${BLUE}                                                                                ${NC}"
echo -e "${BLUE}================================================================================${NC}"
echo ""
...
python -m vcda_net.training.train \
    --data_dir "$DATA_DIR" \
