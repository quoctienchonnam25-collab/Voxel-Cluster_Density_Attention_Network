"""
Hybrid Saliency Map Enhanced V4 - Gated Fusion Architecture
...
class HybridSaliencyEnhanced(nn.Module):
    """
    ...
    def __init__(
        ...
        print(f"\n{'='*70}")
        print(f"HybridSaliencyEnhanced Architecture:")
        print(f"{'='*70}")
...
if __name__ == '__main__':
    # Test
    print("Testing HybridSaliencyEnhanced...")
